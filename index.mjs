// Bulgarian National Bank exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bnb';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'USD', { apiKey }). */
