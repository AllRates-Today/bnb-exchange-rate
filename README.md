# Bulgarian National Bank Exchange Rate API — bnb-exchange-rate
...
Also published under the org scope as [`@allratestoday/bnb-exchange-rate`](https://www.npmjs.com/package/@allratestoday/bnb-exchange-rate) — same code, same versions.
